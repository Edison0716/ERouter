...
class TypeUtils {
    ...
    TypeUtils(Types types, Elements elements) {
        this.types = types;
        parcelableType = elements.getTypeElement(Constants.CLASS_NAME_PARCELABLE).asType();
        serializableType = elements.getTypeElement(Constants.CLASS_NAME_SERIALIZABLE).asType();
    }
